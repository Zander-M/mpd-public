...
env_id, robot_id, num_contexts, num_trajectories_per_context, threshold_start_goal_pos, obstacle_cutoff_margin, trajectory_type = 'EnvEmpty2D', 'RobotPointMass', 4096, 1, 1, 0.02, "linear"
